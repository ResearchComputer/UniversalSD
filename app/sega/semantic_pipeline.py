...
from sega.output import SemanticStableDiffusionPipelineOutput
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for i, t in enumerate(self.progress_bar(timesteps_tensor)):
            ...
            if do_classifier_free_guidance:
                ...
                if enable_edit_guidance:
                    ...
                    for c, noise_pred_edit_concept in enumerate(noise_pred_edit_concepts):
                        ...
                        # check if noise_guidance_edit_tmp is a float16 tensor
                        if noise_guidance_edit_tmp.dtype == torch.float16:
                            tmp = torch.quantile(
            ...
            before_dtype = latents.dtype
            latents = self.scheduler.step(noise_pred, t, latents, **extra_step_kwargs).prev_sample
            latents = latents.to(before_dtype)
